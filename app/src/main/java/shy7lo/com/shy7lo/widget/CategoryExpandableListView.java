...
public class CategoryExpandableListView extends ExpandableListView {
    ...
    private static final String TAG = CategoryExpandableListView.class.getSimpleName();
    ...
    public CategoryExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CategoryExpandableListView(Context context, AttributeSet attrs, int defStyle) {
...
//     * @see ExpandableListView#setAdapter(ExpandableListAdapter)
     */
    public void setAdapter(CategoryExpandableAdapter adapter) {
        super.setAdapter(adapter);

        // Make sure that the adapter extends AnimatedExpandableListAdapter
        if(adapter instanceof CategoryExpandableAdapter) {
            this.adapter = (CategoryExpandableAdapter) adapter;
    ...
    public void setExternalAdapter(CategoryExpandableAdapter adapter) {
        super.setAdapter(adapter);
     ...
     */
    public static abstract class CategoryExpandableAdapter extends BaseExpandableListAdapter {
        private SparseArray<GroupInfo> groupInfo = new SparseArray<GroupInfo>();
        private CategoryExpandableListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(CategoryExpandableListView parent) {
            this.parent = parent;
        }
