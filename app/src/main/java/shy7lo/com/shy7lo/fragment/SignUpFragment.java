...
//                                    event.addCallbackParameter("Country", "" + "" + mCountrty);
                        ...
                        LogUtils.e(TAG_SIGNUP_FRAGMENT, "Response is great::" + jsonElement);
                    } else {
...
//                Utils.showToast(getActivity(), "" + getResources().getString(R.string.msg_something_wrong));
    ...
    private void showCongratulationDialog() {
        ...
        dialog.setContentView(R.layout.dialog_congratulation_signup);

        final TextView tvStart = (TextView) dialog.findViewById(R.id.tvStart);
        final TextView tvNoThanks = (TextView) dialog.findViewById(R.id.tvNoThanks);
