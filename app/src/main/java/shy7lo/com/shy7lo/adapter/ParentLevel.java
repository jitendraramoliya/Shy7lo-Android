...
public class ParentLevel extends BaseExpandableListAdapter {
    ...
    public ParentLevel(Context mContext, CategoryList.MainCategoryData mCategorData, ExpandableListView eListView, OnOptionClickListener onOptionClickListener) {
    ...
    public View getChildView(final int groupPosition, int childPosition,
        ...
        SecondLevelAdapter mSecondLevelAdapter = new SecondLevelAdapter(mContext, mCategorData.getChildrenData().get(groupPosition).getChildrenData().get(childPosition), onOptionClickListener);
        ...
        if (mView != null && mSecondLevelAdapter != null) {
            for (int i = 0; i < mSecondLevelAdapter.getChildrenCount(1); i++) {
                ...
                SubChildData.ChildData mSubChildData = (SubChildData.ChildData) mSecondLevelAdapter.getChild(1, i);
...
//        }
    ...
    public int getGroupCount() {
        if (mCategorData == null || mCategorData.getChildrenData().size() == 0) {
            return 0;
        }
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded,
        ...
        final CategoryList.ChildData mGroupData = (CategoryList.ChildData) getGroup(groupPosition);
...
//        if (isExpanded) {
        if (mGroupData.isSelected()) {
            if (mGroupData == null || mGroupData.getChildrenData().size() == 0) {
        ...
        if (mGroupData.getChildrenData() != null && mGroupData.getChildrenData().size() > 0) {
            for (int i = 0; i < mGroupData.getChildrenData().size(); i++) {
                SubChildData mSubChildData = mGroupData.getChildrenData().get(i);
                if (mSubChildData.isSelected()) {
                    isSelected = true;
                    break;
                }
                if (mSubChildData.getChildrenData() != null && mSubChildData.getChildrenData().size() > 0) {
                    for (int j = 0; j < mSubChildData.getChildrenData().size(); j++) {
                        SubChildData.ChildData mChildData = mSubChildData.getChildrenData().get(j);
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mGroupData == null || mGroupData.getChildrenData().size() == 0) {
                    onOptionClickListener.onOptionClicked(1, mGroupData.getId());
