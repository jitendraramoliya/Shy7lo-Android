...
public class SecondLevelAdapter extends BaseExpandableListAdapter {
    ...
    private SubChildData mChildData;
    private CustExpListview mCustExpListview;
    private ParentLevel.OnOptionClickListener onOptionClickListener;
    int mLastExpandedPosition = -1;

    public SecondLevelAdapter(Context mContext, SubChildData mChildData, ParentLevel.OnOptionClickListener onOptionClickListener) {
    ...
    public Object getChild(int groupPosition, int childPosition) {
        if (mChildData == null || mChildData.getChildrenData().size() == 0) {
            return 0;
        }
        return mChildData.getChildrenData().get(childPosition);
    }
    ...
    public int getChildrenCount(int groupPosition) {
        ...
        return mChildData.getChildrenData().size();
    }
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded,
        ...
        final SubChildData mGroupData = (SubChildData) getGroup(groupPosition);
...
//        }
        ...
        mCustExpListview.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (mGroupData == null || mGroupData.getChildrenData().size() == 0) {
                    onOptionClickListener.onOptionClicked(2, mGroupData.getId());
                }
