...
public class MainCategoryProductAdapter extends BaseAdapter {

    Context mContext;
    MainCategoryForProductFragment mainCategoryForProductFragment;
    List<CategoryProductList.CategoryChild> mValueList = new ArrayList<>();

    public MainCategoryProductAdapter(Context mContext, MainCategoryForProductFragment mainCategoryForProductFragment) {
        this.mContext = mContext;
        this.mainCategoryForProductFragment = mainCategoryForProductFragment;
    }
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.list_item_main_category_product, null);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mainCategoryForProductFragment.checkSubCategoryForProductList(value);
